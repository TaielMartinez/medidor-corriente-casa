...
| 1 | **Fuente 5 V USB** (celular o HLK-5M05) | Alimentación estable del ESP32 |
| 1 | **Protoboard o PCB** | Montaje del front-end analógico |
| — | Cables, borneras, funda termorretráctil | Según instalación |
| 2 | **Transformador de aislamiento** (recomendado) | Solo si alimentás el ESP desde la misma instalación medida; ver §5 |
...
4. Si el medidor comparte tablero con la carga medida, preferir alimentación USB desde un tomacorriente **no** medido o usar fuente aislamiento.
5. Colocar fusible o automático dedicado si el equipo queda fijo en el tablero.
6. Etiquetar claramente: *Casa 1 / Casa 2* en cada SCT.
...
- [ ] ESP32-C3 programable por USB-C
